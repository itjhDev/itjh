//
//  ArticleInteresting TableViewController.swift
//  itjh
//
//  Created by LijunSong on 14/12/15.
...
/**
  首页文章table 分类为趣文
*/
class ArticleInterestingTableViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
